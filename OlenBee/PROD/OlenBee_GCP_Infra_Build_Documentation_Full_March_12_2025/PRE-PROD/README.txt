...
At the top level, the Olenbee.com organization acts as the root entity, encapsulating all projects and resources under a unified management structure.
 ...
 PPRD (Preproduction Applications)
 .............................
 Houses all preproduction workloads, ensuring a clear distinction between infrastructure and application projects.

 Contains critical application components:
  - Beneficiaries-API (e.g., olb-beneficiaries-api-pprd)
...
...........................................
 ...
 - Production (PPRD) – Hosts production applications, including backend and frontend services.
  ...
  └── STANDARD <-- Parent Folder
      ...
      │   └── olb-security-prd 
      | 
      └── PPRD  ---> Preproduction APPS
          |
          ├── Beneficiaries-API 
          |   | 
          │   └── olb-beneficiaries-api-pprd 
          |
          ├── Clients-WEBAPP
          |   |  
          │   ├── Backend  
          │   │   └── olb-clientsapp-api-pprd  
          │   └── Frontend  
          │       └── olb-clientsapp-front-pprd
          | 
          └── Olenbee-BO  
              |
              ├── Backend  
              │   └── olb-backoffice-api-pprd  
              └── Frontend  
                  └── olb-backoffice-front-pprd 
...
ClientsApp API PPRD:
....................
This section provides instructions for building and deploying the ClientsApp API in a preproduction environment.

1- Build your image from the Dockerfile
   - docker build -t europe-west9-docker.pkg.dev/olb-clientsapp-api-pprd/clientsapp/clientsapp .
   - docker psuh europe-west9-docker.pkg.dev/olb-clientsapp-api-pprd/clientsapp/clientsapp:latest

2- Deploy the Cloud Run instance

gcloud run deploy clienstapp \
    --image europe-west9-docker.pkg.dev/olb-clientsapp-api-pprd/clientsapp/clientsapp:latest \
    --region europe-west9 \
    --platform managed \
    --service-account clourun-olenbee@olb-clientsapp-api-pprd.iam.gserviceaccount.com \
    --vpc-connector projects/olb-clientsapp-api-pprd/locations/europe-west9/connectors/olb-pprd-network-glb-netspoke \
    --vpc-egress all-traffic \
    --port 8080 \
    --allow-unauthenticated
...
ClientsApp Front PPRD:
......................
This section outlines the steps to build and deploy the frontend application for ClientsApp in a preproduction environment.

1- Build your image from the Dockerfile
   - docker build -t europe-west9-docker.pkg.dev/olb-clientsapp-front-pprd/clientsapp-front/clientsapp-front .
   - docker psuh europe-west9-docker.pkg.dev/olb-clientsapp-front-pprd/clientsapp-front/clientsapp-front:latest

2- Deploy the Cloud Run instance

gcloud run deploy clientsapp-front \
   --image europe-west9-docker.pkg.dev/olb-clientsapp-front-pprd/clientsapp-front/clientsapp-front:latest \
   --region europe-west9 \
   --platform managed \
   --service-account clourun-olenbee@olb-clientsapp-front-pprd.iam.gserviceaccount.com \
   --vpc-connector projects/olb-clientsapp-api-pprd/locations/europe-west9/connectors/olb-pprd-network-glb-netspoke \
   --vpc-egress all-traffic \
   --port 8080 \
   --allow-unauthenticated
...
Backoffice API PPRD:
....................
This section details the process for deploying the Backoffice API in preproduction.

1- Build your image from the Dockerfile
   - docker build -t europe-west9-docker.pkg.dev/olb-backoffice-api-pprd/backoffice/backoffice .
   - docker psuh europe-west9-docker.pkg.dev/olb-backoffice-api-pprd/backoffice/backoffice:latest

2- Deploy the Cloud Run instance

gcloud run deploy backoffice \
    --image europe-west9-docker.pkg.dev/olb-backoffice-api-pprd/backoffice/backoffice:latest \
    --region europe-west9 \
    --platform managed \
    --service-account clourun-olenbee@olb-backoffice-api-pprd.iam.gserviceaccount.com \
    --vpc-connector projects/olb-backoffice-api-pprd/locations/europe-west9/connectors/olb-pprd-network-glb-netspoke \
    --vpc-egress all-traffic \
    --port 8080 \
    --allow-unauthenticated


Backoffice Front PPRD:
......................
This section provides steps for deploying the frontend interface of the Backoffice application in preproduction.


1- Build your image from the Dockerfile
   - docker build -t europe-west9-docker.pkg.dev/olb-backoffice-front-pprd/backofficefront/backofficefront .
   - docker psuh europe-west9-docker.pkg.dev/olb-backoffice-front-pprd/backofficefront/backofficefront:latest

2- Deploy the Cloud Run instance

gcloud run deploy backofficefront \
   --image europe-west9-docker.pkg.dev/olb-backoffice-front-pprd/backofficefront/backofficefront@sha256:4f1dd64c14b1e780a581e5704c697bf4d18a09ebfcb39929346b3219b22881d6 \
   --region europe-west9 \
   --platform managed \
   --service-account clourun-olenbee@olb-backoffice-front-pprd.iam.gserviceaccount.com \
   --vpc-connector projects/olb-backoffice-api-pprd/locations/europe-west9/connectors/olb-pprd-network-glb-netspoke \
   --vpc-egress all-traffic \
   --port 8080 \
   --allow-unauthenticated
...
Beneficiaries API PPRD:
.......................
This section describes the process for deploying the Beneficiaries API in a preproduction environment.

1- Build your image from the Dockerfile
   - docker build -t europe-west9-docker.pkg.dev/olb-beneficiaries-api-pprd/ms-appdata/ms-appdata .
   - docker psuh europe-west9-docker.pkg.dev/olb-beneficiaries-api-pprd/ms-appdata/ms-appdata:latest

2- Deploy the Cloud Run instance

gcloud run deploy ms-appdata \
   --image europe-west9-docker.pkg.dev/olb-beneficiaries-api-pprd/ms-appdata/ms-appdata@sha256:0e88c194d2bf686afa2528a073cbe83c5571ed2676d6e0c8ece8258cafe3a872 \
   --region europe-west9 \
   --platform managed \
   --service-account clourun-olenbee@olb-beneficiaries-api-pprd.iam.gserviceaccount.com \
   --vpc-connector projects/olb-clientsapp-api-pprd/locations/europe-west9/connectors/olb-pprd-network-glb-netspoke \
   --vpc-egress all-traffic \
   --port 8080 \
   --allow-unauthenticated
