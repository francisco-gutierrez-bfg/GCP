...
...........................................
 ...
 - Production (PRD) – Hosts production applications, including backend and frontend services.
  ...
  └── STANDARD <-- Parent Folder
      ...
      │   ├── olb-netspoke-qa (olb-netspoke-qa-6005) 
      ...
      └── QA  ---> QA APPS
          ...
          ├── Beneficiaries-API 
          |   | 
          │   └── olb-beneficiaries-api-qa  
          |
          ├── Clients-WEBAPP
          |   |  
          │   ├── Backend  
          │   │   └── olb-clientsapp-api-qa  
          │   └── Frontend  
          │       └── olb-clientsapp-front-qa
          | 
          └── Olenbee-BO  
              |
              ├── Backend  
              │   └── olb-backoffice-api-qa
              └── Frontend  
                  └── olb-backoffice-front-qa 
...
1- Build your image from the Dockerfile
   - docker build -t europe-west9-docker.pkg.dev/olb-clientsapp-api-qa/clientsapp/clientsapp .
   - docker psuh europe-west9-docker.pkg.dev/olb-clientsapp-api-qa/clientsapp/clientsapp:latest

2- Deploy the Cloud Run instance

gcloud run deploy clienstapp \
    --image europe-west9-docker.pkg.dev/olb-clientsapp-api-qa/clientsapp/clientsapp:latest \
    --region europe-west9 \
    --platform managed \
    --service-account clourun-olenbee@olb-clientsapp-api-qa.iam.gserviceaccount.com \
    --vpc-connector projects/olb-clientsapp-api-qa/locations/europe-west9/connectors/olb-qa-network-glb-netspoke \
    --vpc-egress all-traffic \
    --port 8080 \
    --allow-unauthenticated
...
1- Build your image from the Dockerfile
   - docker build -t europe-west9-docker.pkg.dev/olb-clientsapp-front-qa/clientsapp-front/clientsapp-front .
   - docker psuh europe-west9-docker.pkg.dev/olb-clientsapp-front-qa/clientsapp-front/clientsapp-front:latest

2- Deploy the Cloud Run instance

gcloud run deploy clientsapp-front \
   --image europe-west9-docker.pkg.dev/olb-clientsapp-front-qa/clientsapp-front/clientsapp-front:latest \
   --region europe-west9 \
   --platform managed \
   --service-account clourun-olenbee@olb-clientsapp-front-qa.iam.gserviceaccount.com \
   --vpc-connector projects/olb-clientsapp-api-qa/locations/europe-west9/connectors/olb-qa-network-glb-netspoke \
   --vpc-egress all-traffic \
   --port 8080 \
   --allow-unauthenticated
...
1- Build your image from the Dockerfile
   - docker build -t europe-west9-docker.pkg.dev/olb-backoffice-api-qa/backoffice/backoffice .
   - docker psuh europe-west9-docker.pkg.dev/olb-backoffice-api-qa/backoffice/backoffice:latest

2- Deploy the Cloud Run instance

gcloud run deploy backoffice \
    --image europe-west9-docker.pkg.dev/olb-backoffice-api-qa/backoffice/backoffice:latest \
    --region europe-west9 \
    --platform managed \
    --service-account clourun-olenbee@olb-backoffice-api-qa.iam.gserviceaccount.com \
    --vpc-connector projects/olb-backoffice-api-qa/locations/europe-west9/connectors/olb-qa-network-glb-netspoke \
    --vpc-egress all-traffic \
    --port 8080 \
    --allow-unauthenticated
...
1- Build your image from the Dockerfile
   - docker build -t europe-west9-docker.pkg.dev/olb-backoffice-front-qa/backofficefront/backofficefront .
   - docker psuh europe-west9-docker.pkg.dev/olb-backoffice-front-qa/backofficefront/backofficefront:latest

2- Deploy the Cloud Run instance

gcloud run deploy backofficefront \
   --image europe-west9-docker.pkg.dev/olb-backoffice-front-qa/backofficefront/backofficefront@sha256:4f1dd64c14b1e780a581e5704c697bf4d18a09ebfcb39929346b3219b22881d6 \
   --region europe-west9 \
   --platform managed \
   --service-account clourun-olenbee@olb-backoffice-front-qa.iam.gserviceaccount.com \
   --vpc-connector projects/olb-backoffice-api-qa/locations/europe-west9/connectors/olb-qa-network-glb-netspoke \
   --vpc-egress all-traffic \
   --port 8080 \
   --allow-unauthenticated
...
Beneficiaries API QA:
......................
This section describes the process for deploying the Beneficiaries API in a dev environment.

1- Build your image from the Dockerfile
   - docker build -t europe-west9-docker.pkg.dev/olb-beneficiaries-api-qa/ms-appdata/ms-appdata .
   - docker psuh europe-west9-docker.pkg.dev/olb-beneficiaries-api-qa/ms-appdata/ms-appdata:latest

2- Deploy the Cloud Run instance

gcloud run deploy ms-appdata \
   --image europe-west9-docker.pkg.dev/olb-beneficiaries-api-qa/ms-appdata/ms-appdata@sha256:0e88c194d2bf686afa2528a073cbe83c5571ed2676d6e0c8ece8258cafe3a872 \
   --region europe-west9 \
   --platform managed \
